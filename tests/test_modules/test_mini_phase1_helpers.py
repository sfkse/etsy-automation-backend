...
These helpers power the ``/research/quick-scrape`` endpoint behind the Chrome
extension's Title Helper tab. It must handle Etsy's __NEXT_DATA__ blob plus the
href-based fallback.
"""
    ...
    cards = [
        {
            "listing_id": "111",
            "title": "First",
            "url": "https://etsy.com/listing/111/first",
        },
        {
            "listing_id": "222",
            "title": "Second",
            "url": "https://etsy.com/listing/222/second",
        },
        {
            "listing_id": "333",
            "title": "Third",
            "url": "https://etsy.com/listing/333/third",
        },
    ]
